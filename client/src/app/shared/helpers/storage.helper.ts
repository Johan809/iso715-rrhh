...
export class StorageHelper {
  ...
  public static setToken(authRes: AuthResponse): void {
    StorageHelper.setItem(StorageKey.TOKEN, authRes.token);
    StorageHelper.setItem(StorageKey.USER_INFO, authRes.data);
  }
